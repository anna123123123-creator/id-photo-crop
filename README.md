...
这个是做 **AI 写真**产品时顺手做的免费小工具——只能裁剪已有照片，不能生成新形象、不能换装换景。完整版是 AI 自动生成证件照、职业形象照、古风日系写真，AI 换装换景 10 分钟出片，源码在这：[AI 写真网站源码](https://inzyxuashop.com/aixiezhen-yuanma.html)。
